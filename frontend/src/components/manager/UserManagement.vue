<template>
  <div>
    ...
    >
      ...
      <Column field="username" header="学号" sortable style="width: 15%"></Column>
      <Column field="trueName" header="姓名" sortable style="width: 10%"></Column>
      ...
      <Column field="role" header="角色" style="width: 10%">
        <template #body="slotProps">
          <Badge :value="slotProps.data.role === 0 ? '管理员' : '学生'" 
...
const editUser = (userData: User) => {
  ...
  // Convert birth string to Date object if it exists
  if (userData.birth) {
