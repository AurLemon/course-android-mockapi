<template>
  <div>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-3xl font-bold text-green-600">{{ stats.noticeCount }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-3xl font-bold text-purple-600">{{ stats.albumCount }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-8">
      ...
      <DataTable :value="recentNotices" :rows="5" stripedRows v-if="recentNotices.length > 0">
    ...
    <div class="bg-white rounded-lg shadow p-6">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <p class="font-semibold">{{ systemInfo.project_name || '学生管理系统' }}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p class="font-semibold">{{ systemInfo.environment || 'development' }}</p>
        </div>
        <div>
